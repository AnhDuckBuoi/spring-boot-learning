...
public class DateTimeFormatter {
    ...
    private String formatInSeconds(Instant instant){
        long elapseSecond = ChronoUnit.SECONDS.between(instant, Instant.now());
        return elapseSecond + " seconds";
    }
    private String formatInMinutes(Instant instant){
        long elapseSecond = ChronoUnit.MINUTES.between(instant, Instant.now());
        return elapseSecond + " minutes";
    }
    private String formatInHours(Instant instant){
        long elapseSecond = ChronoUnit.HOURS.between(instant, Instant.now());
        return elapseSecond + " hours";
    }
    ...
    public String format(Instant instant){
        ...
        var strategy = strategyMap.entrySet().stream().filter(longFunctionEntry -> {
